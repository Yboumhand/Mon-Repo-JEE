...
<%@ page import="java.util.*, com.gestion.model.Sportif, com.gestion.util.HibernateUtil, org.hibernate.*" %>
...
<%
    ...
    try {
        ...
        sportifs = hibernateSession.createQuery("FROM Sportif").list();
    } catch (Exception e) {
        e.printStackTrace();
    } finally {
...
<head>
    ...
    <title>Inscription Sportif - Hibernate</title>
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h3>Formulaire d'inscription (Hibernate)</h3>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="supprimerSportif?code=${sportif.code}" 
                                       ...
                                       onclick="return confirm('Supprimer ce sportif ?')">
                                        Supprimer
                                    </a>
                                </td>
                            </tr>
